      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.topservicesItem} key={item._id}>
            <TouchableOpacity
              onPress={() =>
                handleTopservicesClick(item.title, item.description, item.price, item.image)
              }>
              {/* <Image
                source={{
          ...
          <View style={styles.text9}>
            <TouchableOpacity onPress={() => navigateToScreen('Home')}>
              <Entypo
                ...
                style={[
                  styles.icon4,
                  activeIcon === 'Home' ? { color: '#DAA520' } : { color: 'black' },
                ]}
              />
            </TouchableOpacity>
          ...
          <View style={styles.text9}>
            <TouchableOpacity onPress={() => navigateToScreen('Appointment')}>
              <Entypo
                ...
                style={[
                  styles.icon4,
                  activeIcon === 'Appointment' ? { color: '#DAA520' } : { color: 'black' },
                ]}
              />
            </TouchableOpacity>
          ...
          <View style={styles.text9}>
            <TouchableOpacity onPress={() => navigateToScreen('Notification')}>
              <MaterialIcons
                ...
                style={[
                  styles.icon4,
                  activeIcon === 'Notification' ? { color: '#DAA520' } : { color: 'black' },
                ]}
              />
            </TouchableOpacity>
