...
const ServicePage = ({ navigation }) => {
    ...
    function handleIconPressService(serviceName, serviceDescription, servicePrice, serviceImage) {
        navigation.navigate('Washing', { serviceName, serviceDescription, servicePrice, serviceImage });
    }
    ...
    return (
        <View style={[styles.container, commonStyles]}>
            <FlatList
                refreshControl={
                    <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#5B7586" title="Refreshing..." titleColor="#5B7586" />
                }
                data={servicesData}
                ...
                />
                            <View style={styles.textContainer}>
                                ...
                                <Ionicons name="chevron-forward" size={24} color="black" style={styles.nextIcon} />
                            </View>
                        </TouchableOpacity>
                    </View>
                )}
                    ...
                    <View style={styles.text9}>
                        <TouchableOpacity onPress={() => navigateToScreen('Notification')}>
                            <MaterialIcons
                                ...
                                size={30}
                                style={[styles.icon4, activeIcon === 'Notification' ? { color: '#DAA520' } : { color: 'black' }]}
                            />
                        </TouchableOpacity>
